...
const manifestFilePath = join(__dirname, '../custom_components/eon_next/manifest.json');
const constantFilePath = join(__dirname, '../custom_components/eon_next/const.py');
