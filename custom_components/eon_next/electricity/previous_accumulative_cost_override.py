...
class OctopusEnergyPreviousAccumulativeElectricityCostOverride(CoordinatorEntity, OctopusEnergyElectricitySensor, RestoreSensor):
  ...
  def unique_id(self):
    ...
    return f"eon_next_electricity_{self._serial_number}_{self._mpan}{self._export_id_addition}_previous_accumulative_cost_{self._config[CONFIG_TARIFF_COMPARISON_NAME]}"
